...
urlpatterns = [
    ...
    path('make/offer/', api_views.MakeOfferAPIView.as_view(), name='send-message'),
    path('view/user/inbox/', api_views.UserChatRoomAPIView.as_view(), name='make-offer'),
    path('add/listings/', api_views.CarListingCreate.as_view(), name='car-listing-create'),
    path('listings/<str:category>/', api_views.CarListingByCategoryView.as_view(), name='listings_by_category'),
