...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Listing',
            fields=[
                ('list_id', models.BigAutoField(editable=False, primary_key=True, serialize=False)),
                ('list_price', models.DecimalField(decimal_places=2, max_digits=9)),
                ('assumptor_id', models.ForeignKey(db_column='assumptor_id', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'listing',
            },
